...
public class NacosRegistryServiceImpl implements RegistryService<EventListener> {
    ...
    private static String getNacosNameSpaceFileKey() {
        return FILE_ROOT_REGISTRY + FILE_CONFIG_SPLIT_CHAR + REGISTRY_TYPE + FILE_CONFIG_SPLIT_CHAR + PRO_NAMESPACE_KEY;
    }

    private static String getNacosClusterFileKey() {
        return FILE_ROOT_REGISTRY + FILE_CONFIG_SPLIT_CHAR + REGISTRY_TYPE + FILE_CONFIG_SPLIT_CHAR + REGISTRY_CLUSTER;
    }
}
