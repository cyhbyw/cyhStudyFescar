...
public final class TmRpcClient extends AbstractRpcRemotingClient {
    ...
    private TmRpcClient(NettyClientConfig nettyClientConfig, EventExecutorGroup eventExecutorGroup,
    ...
    private Channel doConnect(String serverAddress) {
        ...
        try {
            RegisterTMRequest registerTransactionManagerRequest =
                    new RegisterTMRequest(applicationId, transactionServiceGroup);
