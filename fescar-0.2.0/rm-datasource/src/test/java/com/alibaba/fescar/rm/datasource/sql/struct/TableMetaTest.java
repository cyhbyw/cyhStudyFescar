...
public class TableMetaTest {
    ...
    private static Object[][] indexMetas = new Object[][] {new Object[] {"PRIMARY", "id", false, "", 3, 1, "A", 34},
        ...
        public DatabaseMetaData getMetaData() throws SQLException {
            ...
            return new DatabaseMetaData() {
                ...
                public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern,
                    ...
                    List<String> columnLabels = Arrays.asList("TABLE_CAT", "TABLE_SCHEM", "TABLE_NAME", "COLUMN_NAME",
                            "DATA_TYPE", "TYPE_NAME", "COLUMN_SIZE", "DECIMAL_DIGITS", "NUM_PREC_RADIX", "NULLABLE",
                            "REMARKS", "COLUMN_DEF", "SQL_DATA_TYPE", "SQL_DATETIME_SUB", "CHAR_OCTET_LENGTH",
                            "ORDINAL_POSITION", "IS_NULLABLE", "IS_AUTOINCREMENT");
                ...
                public ResultSet getIndexInfo(String catalog, String schema, String table, boolean unique,
                    ...
                    List<String> columnLabels = Arrays.asList("INDEX_NAME", "COLUMN_NAME", "NON_UNIQUE",
                            "INDEX_QUALIFIER", "TYPE", "ORDINAL_POSITION", "ASC_OR_DESC", "CARDINALITY");
