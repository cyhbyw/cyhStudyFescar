...
public class ColumnMeta {
    ...
    public String toString() {
        return "ColumnMeta{" + "tableCat='" + tableCat + '\'' + ", tableSchemaName='" + tableSchemaName + '\''
                + ", tableName='" + tableName + '\'' + ", columnName='" + columnName + '\'' + ", dataType=" + dataType
                + ", dataTypeName='" + dataTypeName + '\'' + ", columnSize=" + columnSize + ", decimalDigits="
