...
public class LockManagerTest {
    ...
    public void isLockableTest(BranchSession branchSession) throws Exception {
        ...
        LockManager lockManager = LockManagerFactory.get();
        Assert.assertTrue(lockManager.isLockable(branchSession.getTransactionId(), branchSession.getResourceId(),
                branchSession.getLockKey()));
        lockManager.acquireLock(branchSession);
        branchSession.setTransactionId(UUIDGenerator.generateUUID());
        Assert.assertFalse(lockManager.isLockable(branchSession.getTransactionId(), branchSession.getResourceId(),
                branchSession.getLockKey()));
    }
