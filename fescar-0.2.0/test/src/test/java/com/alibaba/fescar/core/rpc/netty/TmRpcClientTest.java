...
public class TmRpcClientTest {
    ...
    public void testSendMsgWithResponse() throws Exception {
        ...
        BranchRegisterResponse branchRegisterResponse =
                (BranchRegisterResponse) tmRpcClient.sendMsgWithResponse(request);
        ...
        Assert.assertEquals("RuntimeException[SessionManager is NOT init!]", branchRegisterResponse.getMsg());
    }
}
