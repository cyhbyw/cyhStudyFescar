...
public class ConnectionProxy extends AbstractConnectionProxy {
     ...
     * @throws SQLException the sql exception
     */
    public void prepareUndoLog(SQLType sqlType, String tableName, TableRecords beforeImage, TableRecords afterImage)
            throws SQLException {
    ...
    private SQLUndoLog buildUndoItem(SQLType sqlType, String tableName, TableRecords beforeImage,
