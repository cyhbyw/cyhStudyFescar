...
public class RpcServer extends AbstractRpcRemotingServer implements ServerMessageSender {
    ...
    public void setHandler(TransactionMessageHandler handler, RegisterCheckAuthHandler checkAuthHandler) {
        this.transactionMessageHandler = handler;
    ...
    public void init() {
        ...
        DefaultServerMessageListenerImpl listener = new DefaultServerMessageListenerImpl(transactionMessageHandler);
        listener.setServerMessageSender(this);
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        if (LOGGER.isInfoEnabled()) {
            LOGGER.info("channel error: " + cause.getMessage() + ", channel: " + ctx.channel());
        }
