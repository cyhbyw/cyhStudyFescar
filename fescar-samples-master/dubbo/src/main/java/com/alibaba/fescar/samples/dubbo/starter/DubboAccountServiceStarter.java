...
public class DubboAccountServiceStarter {
    ...
    public static void main(String[] args) {
        ...
        accountJdbcTemplate.update("delete from account_tbl where user_id = 'cyh'");
        accountJdbcTemplate.update("insert into account_tbl(user_id, money) values ('cyh', 1000000)");
