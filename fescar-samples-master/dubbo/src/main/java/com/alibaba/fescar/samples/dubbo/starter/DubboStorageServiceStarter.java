...
public class DubboStorageServiceStarter {
    ...
    public static void main(String[] args) {
        ...
        storageJdbcTemplate.update("delete from storage_tbl where commodity_code = 'lightSuite'");
        storageJdbcTemplate.update("insert into storage_tbl(commodity_code, count) values ('lightSuite', 100)");
